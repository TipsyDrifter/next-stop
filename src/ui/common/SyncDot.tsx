 ...
 *
 * 克制度（最重要的一條）：`phase === 'off'`（或狀態還沒讀到）**整顆不渲染**——
 *   沒啟用同步的桌機，視覺上與 v1.1.0 逐像素相同（鐵則「桌機既有行為零改變」）。
 ...
 *   運行中＝金（--color-gold）／停車中＝赭（--color-late）／信号待ち＝朱（--color-seal）。
 *   有動作在飛時慢閃（`prefers-reduced-motion` 關掉）。
